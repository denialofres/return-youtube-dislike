  ...
  data: () => ({
    items: [
      ...
      },
      {
        ...
        answer:
          "Right now video dislikes are cached and they aren't updated very frequently. It varies on video popularity but can take anywhere between a few hours and a few days to update.",
      },
      {
